	...
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="<?php echo base_url()?>assets_buyer/images/11.jpg" alt="" />
			...
			<li>
				<img src="<?php echo base_url()?>assets_buyer/images/22.jpg" alt="" />
				  <div class="slide-desc">
			...
			<li>
				<img src="<?php echo base_url()?>assets_buyer/images/44.jpg" alt="" />
				<div class="slide-desc">
					<h3>Whole Spices Products Are Now On Line With Us</h3>
				</div>
			</li>
